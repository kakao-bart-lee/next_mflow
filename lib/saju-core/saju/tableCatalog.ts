...
const KNOWN_TABLE_CATALOG: Readonly<Record<string, TableCatalogEntry>> = {
  ...
  S128: { code: 'S128', entryId: 'dangsaju_lifetime_overview', title: '당사주 평생총운', showScore: false },
  S129: { code: 'S129', entryId: 'past_life_story', title: '전생 해석', showScore: false },
  S130: { code: 'S130', entryId: 'dangsaju_early_life', title: '당사주 초년운', showScore: false },
  S131: { code: 'S131', entryId: 'dangsaju_middle_life', title: '당사주 중년운', showScore: false },
  S132: { code: 'S132', entryId: 'dangsaju_late_life', title: '당사주 말년운', showScore: false },
  S133: { code: 'S133', entryId: 'dangsaju_spouse_fortune', title: '당사주 배우자운', showScore: false },
  S134: { code: 'S134', entryId: 'dangsaju_children_fortune', title: '당사주 자식운', showScore: false },
  S135: { code: 'S135', entryId: 'dangsaju_sibling_fortune', title: '당사주 형제운', showScore: false },
